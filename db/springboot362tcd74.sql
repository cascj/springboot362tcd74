...
--
-- Host: localhost    Database: springboot362tcd74
-- ------------------------------------------------------
...
--
-- Current Database: `springboot362tcd74`
--

/*!40000 DROP DATABASE IF EXISTS `springboot362tcd74`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `springboot362tcd74` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;

USE `springboot362tcd74`;
...
CREATE TABLE `biaoqian` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='标签';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `biaoqian` VALUES (31,'2025-03-29 13:36:46','标签1'),(32,'2025-03-29 13:36:46','标签2'),(33,'2025-03-29 13:36:46','标签3'),(34,'2025-03-29 13:36:46','标签4'),(35,'2025-03-29 13:36:46','标签5'),(36,'2025-03-29 13:36:46','标签6'),(37,'2025-03-29 13:36:46','标签7'),(38,'2025-03-29 13:36:46','标签8');
/*!40000 ALTER TABLE `biaoqian` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `chapterkechengziyuan`
--

DROP TABLE IF EXISTS `chapterkechengziyuan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `chapterkechengziyuan` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
CREATE TABLE `discusskechengziyuan` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='课程资源评论表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `discusskechengziyuan`
--

LOCK TABLES `discusskechengziyuan` WRITE;
/*!40000 ALTER TABLE `discusskechengziyuan` DISABLE KEYS */;
/*!40000 ALTER TABLE `discusskechengziyuan` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `discussshipinziyuan`
--

DROP TABLE IF EXISTS `discussshipinziyuan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `discussshipinziyuan` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `refid` bigint(20) NOT NULL COMMENT '关联表id',
  `userid` bigint(20) NOT NULL COMMENT '用户id',
  ...
  `reply` longtext COMMENT '回复内容',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='视频资源评论表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `discussshipinziyuan`
--

LOCK TABLES `discussshipinziyuan` WRITE;
/*!40000 ALTER TABLE `discussshipinziyuan` DISABLE KEYS */;
/*!40000 ALTER TABLE `discussshipinziyuan` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `discusswenbenziyuan`
--

DROP TABLE IF EXISTS `discusswenbenziyuan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `discusswenbenziyuan` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `refid` bigint(20) NOT NULL COMMENT '关联表id',
  `userid` bigint(20) NOT NULL COMMENT '用户id',
  ...
  `reply` longtext COMMENT '回复内容',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='文本资源评论表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `discusswenbenziyuan`
--

LOCK TABLES `discusswenbenziyuan` WRITE;
/*!40000 ALTER TABLE `discusswenbenziyuan` DISABLE KEYS */;
/*!40000 ALTER TABLE `discusswenbenziyuan` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `jiaoshi` VALUES (21,'2025-03-29 13:36:46','工号1','123456','教师姓名1','男','773890001@qq.com','13823888881','高级讲师','upload/jiaoshi_touxiang1.jpg',0),(22,'2025-03-29 13:36:46','工号2','123456','教师姓名2','男','773890002@qq.com','13823888882','高级讲师','upload/jiaoshi_touxiang2.jpg',0),(23,'2025-03-29 13:36:46','工号3','123456','教师姓名3','男','773890003@qq.com','13823888883','高级讲师','upload/jiaoshi_touxiang3.jpg',0),(24,'2025-03-29 13:36:46','工号4','123456','教师姓名4','男','773890004@qq.com','13823888884','高级讲师','upload/jiaoshi_touxiang4.jpg',0),(25,'2025-03-29 13:36:46','工号5','123456','教师姓名5','男','773890005@qq.com','13823888885','高级讲师','upload/jiaoshi_touxiang5.jpg',0),(26,'2025-03-29 13:36:46','工号6','123456','教师姓名6','男','773890006@qq.com','13823888886','高级讲师','upload/jiaoshi_touxiang6.jpg',0),(27,'2025-03-29 13:36:46','工号7','123456','教师姓名7','男','773890007@qq.com','13823888887','高级讲师','upload/jiaoshi_touxiang7.jpg',0),(28,'2025-03-29 13:36:46','工号8','123456','教师姓名8','男','773890008@qq.com','13823888888','高级讲师','upload/jiaoshi_touxiang8.jpg',0);
...
CREATE TABLE `kechengziyuan` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=69 DEFAULT CHARSET=utf8 COMMENT='课程资源';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `kechengziyuan`
--

LOCK TABLES `kechengziyuan` WRITE;
/*!40000 ALTER TABLE `kechengziyuan` DISABLE KEYS */;
INSERT INTO `kechengziyuan` VALUES (61,'2025-03-29 13:36:46','资源名称1','upload/kechengziyuan_ziyuantupian1.jpg,upload/kechengziyuan_ziyuantupian2.jpg,upload/kechengziyuan_ziyuantupian3.jpg','标签1','作者1','资源介绍1','2025-03-29','工号1','教师姓名1',1,1,'2025-03-29 21:36:46',0),(62,'2025-03-29 13:36:46','资源名称2','upload/kechengziyuan_ziyuantupian2.jpg,upload/kechengziyuan_ziyuantupian3.jpg,upload/kechengziyuan_ziyuantupian4.jpg','标签2','作者2','资源介绍2','2025-03-29','工号2','教师姓名2',2,2,'2025-03-29 21:36:46',0),(63,'2025-03-29 13:36:46','资源名称3','upload/kechengziyuan_ziyuantupian3.jpg,upload/kechengziyuan_ziyuantupian4.jpg,upload/kechengziyuan_ziyuantupian5.jpg','标签3','作者3','资源介绍3','2025-03-29','工号3','教师姓名3',3,3,'2025-03-29 21:36:46',0),(64,'2025-03-29 13:36:46','资源名称4','upload/kechengziyuan_ziyuantupian4.jpg,upload/kechengziyuan_ziyuantupian5.jpg,upload/kechengziyuan_ziyuantupian6.jpg','标签4','作者4','资源介绍4','2025-03-29','工号4','教师姓名4',4,4,'2025-03-29 21:36:46',0),(65,'2025-03-29 13:36:46','资源名称5','upload/kechengziyuan_ziyuantupian5.jpg,upload/kechengziyuan_ziyuantupian6.jpg,upload/kechengziyuan_ziyuantupian7.jpg','标签5','作者5','资源介绍5','2025-03-29','工号5','教师姓名5',5,5,'2025-03-29 21:36:46',0),(66,'2025-03-29 13:36:46','资源名称6','upload/kechengziyuan_ziyuantupian6.jpg,upload/kechengziyuan_ziyuantupian7.jpg,upload/kechengziyuan_ziyuantupian8.jpg','标签6','作者6','资源介绍6','2025-03-29','工号6','教师姓名6',6,6,'2025-03-29 21:36:46',0),(67,'2025-03-29 13:36:46','资源名称7','upload/kechengziyuan_ziyuantupian7.jpg,upload/kechengziyuan_ziyuantupian8.jpg,upload/kechengziyuan_ziyuantupian9.jpg','标签7','作者7','资源介绍7','2025-03-29','工号7','教师姓名7',7,7,'2025-03-29 21:36:46',0),(68,'2025-03-29 13:36:46','资源名称8','upload/kechengziyuan_ziyuantupian8.jpg,upload/kechengziyuan_ziyuantupian9.jpg,upload/kechengziyuan_ziyuantupian10.jpg','标签8','作者8','资源介绍8','2025-03-29','工号8','教师姓名8',8,8,'2025-03-29 21:36:46',0);
/*!40000 ALTER TABLE `kechengziyuan` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `messages` VALUES (111,'2025-03-29 13:36:46',1,'用户名1','upload/messages_avatarurl1.jpg','留言内容1','upload/messages_cpicture1.jpg','回复内容1','upload/messages_rpicture1.jpg'),(112,'2025-03-29 13:36:46',2,'用户名2','upload/messages_avatarurl2.jpg','留言内容2','upload/messages_cpicture2.jpg','回复内容2','upload/messages_rpicture2.jpg'),(113,'2025-03-29 13:36:46',3,'用户名3','upload/messages_avatarurl3.jpg','留言内容3','upload/messages_cpicture3.jpg','回复内容3','upload/messages_rpicture3.jpg'),(114,'2025-03-29 13:36:46',4,'用户名4','upload/messages_avatarurl4.jpg','留言内容4','upload/messages_cpicture4.jpg','回复内容4','upload/messages_rpicture4.jpg'),(115,'2025-03-29 13:36:46',5,'用户名5','upload/messages_avatarurl5.jpg','留言内容5','upload/messages_cpicture5.jpg','回复内容5','upload/messages_rpicture5.jpg'),(116,'2025-03-29 13:36:46',6,'用户名6','upload/messages_avatarurl6.jpg','留言内容6','upload/messages_cpicture6.jpg','回复内容6','upload/messages_rpicture6.jpg'),(117,'2025-03-29 13:36:46',7,'用户名7','upload/messages_avatarurl7.jpg','留言内容7','upload/messages_cpicture7.jpg','回复内容7','upload/messages_rpicture7.jpg'),(118,'2025-03-29 13:36:46',8,'用户名8','upload/messages_avatarurl8.jpg','留言内容8','upload/messages_cpicture8.jpg','回复内容8','upload/messages_rpicture8.jpg');
...
INSERT INTO `newstype` VALUES (71,'2025-03-29 13:36:46','分类名称1'),(72,'2025-03-29 13:36:46','分类名称2'),(73,'2025-03-29 13:36:46','分类名称3'),(74,'2025-03-29 13:36:46','分类名称4'),(75,'2025-03-29 13:36:46','分类名称5'),(76,'2025-03-29 13:36:46','分类名称6'),(77,'2025-03-29 13:36:46','分类名称7'),(78,'2025-03-29 13:36:46','分类名称8');
/*!40000 ALTER TABLE `newstype` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `shipinziyuan`
--

DROP TABLE IF EXISTS `shipinziyuan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shipinziyuan` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `ziyuanmingcheng` varchar(200) NOT NULL COMMENT '资源名称',
  `ziyuantupian` longtext COMMENT '资源图片',
  ...
  `discussnum` int(11) DEFAULT '0' COMMENT '评论数',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8 COMMENT='视频资源';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `shipinziyuan`
--

LOCK TABLES `shipinziyuan` WRITE;
/*!40000 ALTER TABLE `shipinziyuan` DISABLE KEYS */;
INSERT INTO `shipinziyuan` VALUES (51,'2025-03-29 13:36:46','资源名称1','upload/shipinziyuan_ziyuantupian1.jpg,upload/shipinziyuan_ziyuantupian2.jpg,upload/shipinziyuan_ziyuantupian3.jpg','标签1','作者1','','资源介绍1','2025-03-29','工号1','教师姓名1',1,1,'2025-03-29 21:36:46',0),(52,'2025-03-29 13:36:46','资源名称2','upload/shipinziyuan_ziyuantupian2.jpg,upload/shipinziyuan_ziyuantupian3.jpg,upload/shipinziyuan_ziyuantupian4.jpg','标签2','作者2','','资源介绍2','2025-03-29','工号2','教师姓名2',2,2,'2025-03-29 21:36:46',0),(53,'2025-03-29 13:36:46','资源名称3','upload/shipinziyuan_ziyuantupian3.jpg,upload/shipinziyuan_ziyuantupian4.jpg,upload/shipinziyuan_ziyuantupian5.jpg','标签3','作者3','','资源介绍3','2025-03-29','工号3','教师姓名3',3,3,'2025-03-29 21:36:46',0),(54,'2025-03-29 13:36:46','资源名称4','upload/shipinziyuan_ziyuantupian4.jpg,upload/shipinziyuan_ziyuantupian5.jpg,upload/shipinziyuan_ziyuantupian6.jpg','标签4','作者4','','资源介绍4','2025-03-29','工号4','教师姓名4',4,4,'2025-03-29 21:36:46',0),(55,'2025-03-29 13:36:46','资源名称5','upload/shipinziyuan_ziyuantupian5.jpg,upload/shipinziyuan_ziyuantupian6.jpg,upload/shipinziyuan_ziyuantupian7.jpg','标签5','作者5','','资源介绍5','2025-03-29','工号5','教师姓名5',5,5,'2025-03-29 21:36:46',0),(56,'2025-03-29 13:36:46','资源名称6','upload/shipinziyuan_ziyuantupian6.jpg,upload/shipinziyuan_ziyuantupian7.jpg,upload/shipinziyuan_ziyuantupian8.jpg','标签6','作者6','','资源介绍6','2025-03-29','工号6','教师姓名6',6,6,'2025-03-29 21:36:46',0),(57,'2025-03-29 13:36:46','资源名称7','upload/shipinziyuan_ziyuantupian7.jpg,upload/shipinziyuan_ziyuantupian8.jpg,upload/shipinziyuan_ziyuantupian9.jpg','标签7','作者7','','资源介绍7','2025-03-29','工号7','教师姓名7',7,7,'2025-03-29 21:36:46',0),(58,'2025-03-29 13:36:46','资源名称8','upload/shipinziyuan_ziyuantupian8.jpg,upload/shipinziyuan_ziyuantupian9.jpg,upload/shipinziyuan_ziyuantupian10.jpg','标签8','作者8','','资源介绍8','2025-03-29','工号8','教师姓名8',8,8,'2025-03-29 21:36:46',0);
/*!40000 ALTER TABLE `shipinziyuan` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `token` VALUES (1,1711719838278,'111','xuesheng','学生','bnnbjwig8fqcsz84bcxgfcfx8dljyopu','2025-03-29 13:44:13','2025-03-29 14:44:14');
...
INSERT INTO `users` VALUES (1,'admin','admin','upload/image1.jpg','管理员','2025-03-29 13:36:46');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `wenbenziyuan`
--

DROP TABLE IF EXISTS `wenbenziyuan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wenbenziyuan` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `ziyuanmingcheng` varchar(200) NOT NULL COMMENT '资源名称',
  `ziyuantupian` longtext COMMENT '资源图片',
  ...
  `zuozhe` varchar(200) NOT NULL COMMENT '作者',
  `ziyuanjieshao` longtext COMMENT '资源介绍',
  `ziyuanfujian` longtext NOT NULL COMMENT '资源附件',
  `wenbenneirong` longtext COMMENT '文本内容',
  `faburiqi` date DEFAULT NULL COMMENT '发布日期',
  `gonghao` varchar(200) DEFAULT NULL COMMENT '工号',
  `jiaoshixingming` varchar(200) DEFAULT NULL COMMENT '教师姓名',
  `thumbsupnum` int(11) DEFAULT '0' COMMENT '赞',
  ...
  `discussnum` int(11) DEFAULT '0' COMMENT '评论数',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8 COMMENT='文本资源';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `wenbenziyuan`
--

LOCK TABLES `wenbenziyuan` WRITE;
/*!40000 ALTER TABLE `wenbenziyuan` DISABLE KEYS */;
INSERT INTO `wenbenziyuan` VALUES (41,'2025-03-29 13:36:46','资源名称1','upload/wenbenziyuan_ziyuantupian1.jpg,upload/wenbenziyuan_ziyuantupian2.jpg,upload/wenbenziyuan_ziyuantupian3.jpg','标签1','作者1','资源介绍1','','文本内容1','2025-03-29','工号1','教师姓名1',1,1,'2025-03-29 21:36:46',0),(42,'2025-03-29 13:36:46','资源名称2','upload/wenbenziyuan_ziyuantupian2.jpg,upload/wenbenziyuan_ziyuantupian3.jpg,upload/wenbenziyuan_ziyuantupian4.jpg','标签2','作者2','资源介绍2','','文本内容2','2025-03-29','工号2','教师姓名2',2,2,'2025-03-29 21:36:46',0),(43,'2025-03-29 13:36:46','资源名称3','upload/wenbenziyuan_ziyuantupian3.jpg,upload/wenbenziyuan_ziyuantupian4.jpg,upload/wenbenziyuan_ziyuantupian5.jpg','标签3','作者3','资源介绍3','','文本内容3','2025-03-29','工号3','教师姓名3',3,3,'2025-03-29 21:36:46',0),(44,'2025-03-29 13:36:46','资源名称4','upload/wenbenziyuan_ziyuantupian4.jpg,upload/wenbenziyuan_ziyuantupian5.jpg,upload/wenbenziyuan_ziyuantupian6.jpg','标签4','作者4','资源介绍4','','文本内容4','2025-03-29','工号4','教师姓名4',4,4,'2025-03-29 21:36:46',0),(45,'2025-03-29 13:36:46','资源名称5','upload/wenbenziyuan_ziyuantupian5.jpg,upload/wenbenziyuan_ziyuantupian6.jpg,upload/wenbenziyuan_ziyuantupian7.jpg','标签5','作者5','资源介绍5','','文本内容5','2025-03-29','工号5','教师姓名5',5,5,'2025-03-29 21:36:46',0),(46,'2025-03-29 13:36:46','资源名称6','upload/wenbenziyuan_ziyuantupian6.jpg,upload/wenbenziyuan_ziyuantupian7.jpg,upload/wenbenziyuan_ziyuantupian8.jpg','标签6','作者6','资源介绍6','','文本内容6','2025-03-29','工号6','教师姓名6',6,6,'2025-03-29 21:36:46',0),(47,'2025-03-29 13:36:46','资源名称7','upload/wenbenziyuan_ziyuantupian7.jpg,upload/wenbenziyuan_ziyuantupian8.jpg,upload/wenbenziyuan_ziyuantupian9.jpg','标签7','作者7','资源介绍7','','文本内容7','2025-03-29','工号7','教师姓名7',7,7,'2025-03-29 21:36:46',0),(48,'2025-03-29 13:36:46','资源名称8','upload/wenbenziyuan_ziyuantupian8.jpg,upload/wenbenziyuan_ziyuantupian9.jpg,upload/wenbenziyuan_ziyuantupian10.jpg','标签8','作者8','资源介绍8','','文本内容8','2025-03-29','工号8','教师姓名8',8,8,'2025-03-29 21:36:46',0);
/*!40000 ALTER TABLE `wenbenziyuan` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=1711719838279 DEFAULT CHARSET=utf8 COMMENT='学生';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `xuesheng` VALUES (11,'2025-03-29 13:36:46','学号1','123456','学生姓名1','男','773890001@qq.com','13823888881','学校1','标签1','院系1','专业1','班级1','upload/xuesheng_touxiang1.jpg',0),(12,'2025-03-29 13:36:46','学号2','123456','学生姓名2','男','773890002@qq.com','13823888882','学校2','标签2','院系2','专业2','班级2','upload/xuesheng_touxiang2.jpg',0),(13,'2025-03-29 13:36:46','学号3','123456','学生姓名3','男','773890003@qq.com','13823888883','学校3','标签3','院系3','专业3','班级3','upload/xuesheng_touxiang3.jpg',0),(14,'2025-03-29 13:36:46','学号4','123456','学生姓名4','男','773890004@qq.com','13823888884','学校4','标签4','院系4','专业4','班级4','upload/xuesheng_touxiang4.jpg',0),(15,'2025-03-29 13:36:46','学号5','123456','学生姓名5','男','773890005@qq.com','13823888885','学校5','标签5','院系5','专业5','班级5','upload/xuesheng_touxiang5.jpg',0),(16,'2025-03-29 13:36:46','学号6','123456','学生姓名6','男','773890006@qq.com','13823888886','学校6','标签6','院系6','专业6','班级6','upload/xuesheng_touxiang6.jpg',0),(17,'2025-03-29 13:36:46','学号7','123456','学生姓名7','男','773890007@qq.com','13823888887','学校7','标签7','院系7','专业7','班级7','upload/xuesheng_touxiang7.jpg',0),(18,'2025-03-29 13:36:46','学号8','123456','学生姓名8','男','773890008@qq.com','13823888888','学校8','标签8','院系8','专业8','班级8','upload/xuesheng_touxiang8.jpg',0),(1711719838278,'2025-03-29 13:43:58','111','11','测试1','女','131@163.com','13111111111','测试1','标签3,标签2','测试1','测试2','测试3','upload/1711719786670.jpg',0);
...
-- Dump completed on 2025-03-31 22:01:51
